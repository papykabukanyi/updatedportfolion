...
export const metadata = {
  ...
  description:
    'CROW News — independent, unfiltered news and commentary. Breaking stories, in-depth analysis, investigative journalism, and local Austin TX coverage. Powered by Papy Kabukanyi.',
  keywords: [
    ...
    'noticias Austin TX', 'nouvelles Austin TX', 'Austin новости',
    'Austin habari',
  ],
