...
// Sign up free at https://resend.com ? get API key ? add RESEND_API_KEY to Railway env vars
        ...
        <tr>
          <td style="padding:24px 28px">
            <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:20px">
              <tr>
                <td style="padding:8px 0;width:90px;color:#64748b;font-size:13px;text-transform:uppercase">Name</td>
              ...
              <tr><td colspan="2" style="border-bottom:1px solid rgba(255,255,255,0.05)"></td></tr>
              <tr>
                <td style="padding:8px 0;color:#64748b;font-size:13px;text-transform:uppercase">Subject</td>
