      ...
      <header className="border-b-4 border-black">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex flex-col gap-1">
            <a href={PORTFOLIO_URL} className="text-xs text-gray-500 hover:text-black transition-colors font-sans">
              ← Portfolio
            </a>
            <a href={STORE_URL} className="text-xs text-amber-700 hover:text-amber-900 transition-colors font-sans">
              🛍 Papi&apos;s Store
            </a>
          </div>
          ...
          {featured && (
            <article className="col-span-7 border-r border-gray-400 pr-3 flex flex-col">
              <div className="flex-1 overflow-hidden">
                ...
                <p className="text-xs text-gray-400 font-sans mt-1">{timeLabel(featured)}</p>
              </div>
              {/* Reactions */}
