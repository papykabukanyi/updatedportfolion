...
export const metadata = {
  ...
  title: {
    default: "Papi's Store | Austin TX Online Shop — Quality Finds",
    template: "%s | Papi's Store",
  },
  description:
    "Papi's Store — quality products, unique finds, fast shipping. Austin TX based online shop curated by Papy Kabukanyi. Shop apparel, accessories, tech, and more.",
  keywords: [
    ...
    'интернет магазин Остин', 'duka la mtandao Austin',
