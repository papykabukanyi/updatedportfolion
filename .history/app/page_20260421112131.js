  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <div className="sm:hidden fixed bottom-0 inset-x-0 z-40 bg-white border-t border-gray-100 px-4 pt-3 pb-5 safe-bottom">
        <button onClick={openForm}
          className="w-full bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white font-black py-4 rounded-2xl text-base tracking-wide active:scale-[0.97] transition-all duration-200 shadow-lg shadow-orange-500/40 hover:shadow-xl hover:shadow-orange-500/50">
          Get Free Estimate →
        </button>
                  ...
                  {cur.type === 'multi' && (
                    <div className="flex flex-col gap-2 mt-6">
                      <button type="button" onClick={() => setStep(s => s + 1)} disabled={!canNext()}
                        className="w-full bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 disabled:from-gray-400 disabled:to-gray-500 disabled:cursor-not-allowed disabled:text-gray-200 text-white font-black py-4 rounded-2xl text-base tracking-wide transition-all duration-200 disabled:shadow-none active:scale-[0.98] focus:outline-none shadow-lg shadow-orange-500/40 hover:shadow-xl hover:shadow-orange-500/50"
