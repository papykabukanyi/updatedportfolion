  ...
  return (
    <section id="github" className="py-24 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Profile card */}
        {user && (
          <div className="glass-card p-7 mb-8 flex flex-col sm:flex-row items-center gap-6">
            <Image
              src={user.avatar_url}
              alt={user.login}
              width={80}
            ...
            <a
              ...
              className="flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-cyan-500 to-purple-600 text-white font-semibold hover:opacity-90 transition-all shadow-lg shadow-cyan-500/20 flex-shrink-0"
            >
              <FiGithub size={16} />
              View Profile
