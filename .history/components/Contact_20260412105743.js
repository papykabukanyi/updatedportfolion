      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-slate-400 mt-4 max-w-lg mx-auto text-lg">
            I&apos;m open to web development and AI prompt engineering opportunities.
          ...
          >
            ...
            <div className="glass-card p-5 mt-2 border-cyan-500/15">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-cyan-400 text-sm font-semibold">Available for hire</span>
              </div>
              <p className="text-slate-500 text-xs leading-relaxed">
                Open to full-time, contract, and freelance roles in Web Development &amp; AI Prompt Engineering.
              </p>
            </div>
          </motion.div>
