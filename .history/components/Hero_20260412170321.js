    ...
    >
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto pt-24">
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-6xl md:text-[80px] font-black tracking-tight mb-4 leading-[1.05]"
        >
        ...
        <motion.div
          ...
          className="h-12 sm:h-14 flex items-center justify-center text-xl sm:text-3xl md:text-4xl font-bold mb-6"
        >
        ...
        <motion.p
          ...
          className="text-slate-400 text-base sm:text-lg max-w-2xl mx-auto mb-8 leading-relaxed px-2"
        >
          {t.hero.tagline}
        </motion.p>
        ...
        <motion.div
          ...
          className="flex flex-col sm:flex-row flex-wrap items-center justify-center gap-3 sm:gap-5 mb-10 text-sm text-slate-500"
        >
        ...
        >
          ...
          <a
            ...
            className="w-full sm:w-auto flex items-center justify-center gap-2 px-8 py-3.5 rounded-xl border border-cyan-500/30 bg-cyan-500/5 text-cyan-400 font-semibold hover:bg-cyan-500/15 hover:border-cyan-500/60 transition-all duration-200"
          >
            <FiDownload size={16} />
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-full sm:w-auto flex items-center justify-center gap-2 px-8 py-3.5 rounded-xl border border-purple-500/30 bg-purple-500/5 text-purple-400 font-semibold hover:bg-purple-500/15 transition-all duration-200"
          >
            <FiGithub size={16} />
            GitHub
          </a>
